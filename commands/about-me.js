module.exports = {
    ...
    execute(message) {
        ...
        const embed = new Discord.MessageEmbed()
            .setColor()
            .setTitle('About me')
            .setImage('https://github.com/brakenium/Vanu-s-Enlightenment/raw/master/images/me.png')
            ...
            .addField('Misc.', `Currently I have **${commands.length}** commands which can be shown using **!help**. My code resides on a raspberry pi 2 and is licensed under the MIT license. If you want to view my code you can do so on [GitHub](https://github.com/brakenium/Vanu-s-Enlightenment)`);
